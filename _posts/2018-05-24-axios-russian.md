...
Для Вашего удобства были созданы методы для всех поддерживаемых видов запросов.
...
P.S. в следующих статьях рассмотрим применение axios в "боевых" условия, используюя React JS.
